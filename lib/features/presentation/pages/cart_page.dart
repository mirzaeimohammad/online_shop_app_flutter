...
import 'package:oline_shop_app/features/presentation/widgets/cart_product_card_widget.dart';

class CartPage extends StatefulWidget {
  final ProductItemEntity product;
  final List<ProductItemEntity> list;
  const CartPage({Key? key, required this.product, required this.list})
      : super(key: key);
